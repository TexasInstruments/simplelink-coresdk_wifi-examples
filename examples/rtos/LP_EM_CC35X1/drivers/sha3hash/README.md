...
This example shows how to use the SHA3 driver. The target accepts input over a
...
* The target will hash the string using SHA3 and echo back the result.

To confirm the example is behaving properly, the expected output for the input
string "This is a demo string." is
`DBC44D48C308370245EC35153242C0C0216D7B96A363A19623A014A96402CAE9`

## Application Design Details

This examples shows how to use the SHA3 driver in single step hash mode.

> The example expects the input string to be encoded in ASCII binary format. The
user must make sure that the character binary representation used by the host
side serial tool corresponds to that of the ASCII binary format.
